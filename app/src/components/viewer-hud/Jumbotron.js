...
import Properties from '../viewer-properties';
import {
  viewerResize,
  viewerExplode,
  toggleExplosion,
  ...
  render() {
    ...
    return (
      <div className="forge-jumbotron">
        <Viewer />
        <div className="forge-logo">LOGO</div>
        <div className="container safari-only">
          ...
          <button
            ...
            onClick={this.onPropertiesDisplay}
          >
